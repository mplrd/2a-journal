...
echo "Created account: FTMO Challenge (id={$accountId})\n";
...
// ── 5. Create trades ────────────────────────────────────────
$trades = [
    // [symbol, direction, entry, sl_points, exit_price, exit_type, setup, opened_at, closed_at, size]
    ['NASDAQ', 'BUY',  18500, 50, 18620, 'TP', 'Breakout',     '2026-01-06 09:30:00', '2026-01-06 11:15:00', 1],
    ['NASDAQ', 'SELL', 18600, 40, 18520, 'TP', 'Reversal',     '2026-01-07 10:00:00', '2026-01-07 12:30:00', 1],
    ['DAX',    'BUY',  17800, 30, 17750, 'SL', 'Pullback',     '2026-01-08 08:00:00', '2026-01-08 08:45:00', 2],
    ['EURUSD', 'BUY',  1.0850, 0.0030, 1.0920, 'TP', 'Trend Follow', '2026-01-09 14:00:00', '2026-01-09 17:00:00', 1],
    ['NASDAQ', 'BUY',  18400, 60, 18400, 'BE', 'Breakout',     '2026-01-10 09:00:00', '2026-01-10 10:30:00', 1],
    ['GBPUSD', 'SELL', 1.2700, 0.0025, 1.2640, 'TP', 'Range',       '2026-01-13 10:00:00', '2026-01-13 15:00:00', 2],
    ['DAX',    'BUY',  17900, 25, 17980, 'TP', 'Pullback',     '2026-01-14 08:30:00', '2026-01-14 10:00:00', 1],
    ['NASDAQ', 'SELL', 18700, 45, 18760, 'SL', 'Reversal',     '2026-01-15 09:30:00', '2026-01-15 10:00:00', 1],
    ['BTCUSD', 'BUY',  42000, 500, 43200, 'TP', 'Breakout',   '2026-01-16 12:00:00', '2026-01-17 08:00:00', 0.5],
    ['EURUSD', 'SELL', 1.0900, 0.0020, 1.0870, 'TP', 'Trend Follow', '2026-01-20 09:00:00', '2026-01-20 13:00:00', 3],
    ['NASDAQ', 'BUY',  18550, 50, 18700, 'TP', 'Breakout',     '2026-01-21 09:30:00', '2026-01-21 14:00:00', 1],
    ['DAX',    'SELL', 18000, 35, 17920, 'TP', 'Range',         '2026-01-22 08:00:00', '2026-01-22 11:00:00', 1],
    ['NASDAQ', 'BUY',  18650, 55, 18580, 'SL', 'Pullback',     '2026-01-23 10:00:00', '2026-01-23 10:45:00', 1],
    ['GBPUSD', 'BUY',  1.2650, 0.0030, 1.2720, 'TP', 'Trend Follow', '2026-01-24 08:00:00', '2026-01-24 16:00:00', 2],
    ['BTCUSD', 'SELL', 43500, 600, 43000, 'TP', 'Reversal',   '2026-01-27 10:00:00', '2026-01-28 09:00:00', 0.3],
    ['NASDAQ', 'BUY',  18800, 40, 18900, 'TP', 'Breakout',     '2026-01-28 09:30:00', '2026-01-28 12:00:00', 1],
    ['DAX',    'BUY',  18100, 30, 18050, 'SL', 'Pullback',     '2026-01-29 08:15:00', '2026-01-29 08:50:00', 1],
    ['EURUSD', 'BUY',  1.0820, 0.0025, 1.0880, 'TP', 'Range',   '2026-01-30 14:00:00', '2026-01-30 17:30:00', 2],
    ['NASDAQ', 'SELL', 18950, 50, 18850, 'TP', 'Reversal',     '2026-02-03 09:30:00', '2026-02-03 11:00:00', 1],
    ['DAX',    'BUY',  18200, 20, 18260, 'TP', 'Trend Follow', '2026-02-04 08:00:00', '2026-02-04 09:30:00', 2],
    ['GBPUSD', 'SELL', 1.2580, 0.0020, 1.2600, 'SL', 'Range',   '2026-02-05 10:00:00', '2026-02-05 11:00:00', 1],
    ['NASDAQ', 'BUY',  19000, 60, 19000, 'BE', 'Breakout',     '2026-02-06 09:30:00', '2026-02-06 12:00:00', 1],
    ['BTCUSD', 'BUY',  44000, 800, 45500, 'TP', 'Breakout',   '2026-02-07 08:00:00', '2026-02-10 10:00:00', 0.5],
    ['EURUSD', 'SELL', 1.0950, 0.0035, 1.0900, 'TP', 'Pullback', '2026-02-10 09:00:00', '2026-02-10 15:00:00', 2],
    ['NASDAQ', 'BUY',  19100, 45, 19200, 'TP', 'Trend Follow', '2026-02-11 09:30:00', '2026-02-11 14:30:00', 1],
    ['DAX',    'SELL', 18300, 25, 18340, 'SL', 'Reversal',     '2026-02-12 08:00:00', '2026-02-12 08:40:00', 1],
    ['NASDAQ', 'BUY',  19150, 50, 19280, 'TP', 'Breakout',     '2026-02-13 09:30:00', '2026-02-13 13:00:00', 1],
    ['GBPUSD', 'BUY',  1.2700, 0.0020, 1.2750, 'TP', 'Trend Follow', '2026-02-17 10:00:00', '2026-02-17 16:00:00', 3],
    ['DAX',    'BUY',  18400, 30, 18500, 'TP', 'Pullback',     '2026-02-18 08:00:00', '2026-02-18 10:30:00', 1],
    ['NASDAQ', 'SELL', 19300, 40, 19350, 'SL', 'Range',         '2026-02-19 09:30:00', '2026-02-19 10:00:00', 1],
];

$tradeCount = 0;
foreach ($trades as [$symbol, $direction, $entry, $slPoints, $exitPrice, $exitType, $setup, $openedAt, $closedAt, $size]) {
    // Calculate SL price
    if ($direction === 'BUY') {
