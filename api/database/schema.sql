...
CREATE TABLE IF NOT EXISTS setups (
    ...
    category ENUM('timeframe','pattern','context') NULL DEFAULT NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP NULL DEFAULT NULL,
...
-- Personal, free-form trading notes with user-defined categories. 2A never
-- analyses these — see migration 030_notebook.sql for the full rationale.
